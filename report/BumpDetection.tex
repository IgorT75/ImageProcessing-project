...
Following code assumes that name of input file is \bd{01\_Gray8bit.jpg} and that this image is 8-bit. It was converted to 8-bit image from original Image1.gif file.
\lstinputlisting[language=Python]{../bump\_detect.py}
\newpage
